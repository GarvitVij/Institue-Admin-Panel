...
import classes from '../BasicStyles.module.css'
   ...
   const DeleteBatch = (props) => {
        let visibleComponent = <div> <Typography>No batch was selected</Typography> <div className={classes.Center}> <Button variant="contained" className={classes.Safe}>Cancle</Button></div></div>
