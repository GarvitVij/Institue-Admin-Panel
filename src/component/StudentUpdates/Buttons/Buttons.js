   ...
   const Buttons = (props) => {
    ...
    const [error, setError] = useState(null)
       ...
       return(
        ...
        <Modal heading="Increase Semester" modalState={props.modalName === "Increase Semester" ? true : false} onModalOpen={props.onModalOpen} onModalClose={props.onModalClose}><PromoteHold close={props.onModalClose}/></Modal>
